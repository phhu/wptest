...
<div class="pathway-notice-dont-show-container">
    <button class="button-link pathway-dont-show-notice">
        <?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="pathway-admin-notice-spacer">
    <div class="pathway-admin-big-notice--container">
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', pathway_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', pathway_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo pathway_theme()->getListMarkerUrl()?>" alt="">
