...
$pathway_theme_divider_style = array(
...
return array(
	'default_icon'                      => $pathway_theme_svg_icons['fort-awesome'],
	'icons'                             => $pathway_theme_svg_icons,
	'divider_style'                     => $pathway_theme_divider_style,
	'lorem_ipsum'                       => $pathway_lorem_ipsum,
	'edit_this_text_in_customizer'      => $pathway_theme_click_pen_to_edit_title,
	'gradients'                         => $pathway_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $pathway_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $pathway_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $pathway_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $pathway_gradients['night_fade'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $pathway_theme_svg_icons['facebook'],
						'link_value' => 'https://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $pathway_theme_svg_icons['twitter'],
						'link_value' => 'https://www.twitter.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $pathway_theme_svg_icons['youtube'],
						'link_value' => 'https://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $pathway_theme_svg_icons['instagram'],
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $pathway_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $pathway_theme_svg_icons['phone'],
						'text'       => '(000) 123 12345',
						'link_value' => 'tel:(000) 123 12345',
						'index'      => 1,
					),
					array(
						'icon'       => $pathway_theme_svg_icons['envelope'],
						...
						'background' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										'url'      => get_template_directory_uri() . '/resources/images/background-image.jpg',
										'gradient' => $pathway_gradients['default'],
									),
									'attachment' => 'scroll',
								),
							),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $pathway_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					...
					array(
						'icon'       => $pathway_theme_svg_icons['phone-square'],
						'text'       => '(000) 123 12345',
						'link_value' => '#',
						'index'      => 1,
					),
